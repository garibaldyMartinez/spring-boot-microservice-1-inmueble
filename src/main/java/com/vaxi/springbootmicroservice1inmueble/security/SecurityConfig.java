...
public class SecurityConfig {
    ...
    private String SECURE_KEY_USER_NAME_2;

    @Value("${service.security.secure-key-password-2}")
    private String SECURE_KEY_USER_PASSWORD_2;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        ...
        authenticationManagerBuilder.inMemoryAuthentication()
                ...
                .and()
                .withUser(SECURE_KEY_USER_NAME_2)
                .password(new BCryptPasswordEncoder().encode(SECURE_KEY_USER_PASSWORD_2))
